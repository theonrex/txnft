...
contract TX is ERC721Enumerable, Ownable {
    ...
    //  _price is the price of one TX NFT
    ...
    /**
        ...
        * name in our case is `TX` and symbol is `LW3P`.
        * Constructor for LW3P takes in the baseURI to set _baseTokenURI for the collection.
        */
    constructor (string memory baseURI) ERC721("TX", "LW3P") {
    ...
    */
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Exceed maximum TX supply");
